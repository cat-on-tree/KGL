...
def extract_label_from_gold(text):
...
def main(model_file, gold_file, report_file):
    ...
    with open(gold_file, "r", encoding="utf-8") as fin:
        for line in fin:
            ...
            obj = json.loads(line)
            idx = obj["idx"]
            gt_label = extract_label_from_gold(obj["data"])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--benchmark", default="data/evaluation/benchmark/bioRED.json", help="金标准jsonl文件")
